...
%\begin{math} {\scriptstyle \mu _{x}}\end{math} represents the average of B, A represents the average of BB


%{\scriptstyle \mu _{x}} the average of {\scriptstyle x} {\scriptstyle \mu _{y}} the average of %{\scriptstyle y}
%{\scriptstyle \sigma _{x}^{2}} the variance of {\scriptstyle x};
%{\scriptstyle \sigma _{y}^{2}} the variance of {\displaystyle \scriptstyle y};
%{\scriptstyle \sigma _{xy}} the covariance of {\displaystyle \scriptstyle x} and {\displaystyle \scriptstyle y};
%{\scriptstyle c_{1}=(k_{1}L)^{2}}, {\scriptstyle c_{2}=(k_{2}L)^{2}} two variables to stabilize the division with weak denominator;
%\end{math}
